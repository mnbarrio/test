...
export interface Scheduler extends BaseElement, SchedulerProperties {
   ...
   * This event is triggered when en event is clicked.
	* @param event. The custom event. Custom data event was created with: ev.detail(item, itemObj)
   ...
   * @returns {boolean}
   */
  containsEvent(eventObj: SchedulerEvent): boolean;
  /**
   * Inserts an event.
   ...
   */
  insertEvent(eventObj: SchedulerEvent, index?: number): void;
  /**
   * Updates an event.
   ...
   */
  updateEvent(index: number | SchedulerEvent, eventObj: SchedulerEvent): void;
  /**
   * Removes an event.
   ...
   */
  openWindow(index: number | SchedulerEvent): void;
  /**
   ...
   */
  scrollToEvent(index: SchedulerEvent | number): void;
  /**
   ...
   */
  occurrencesBetween(eventObj: SchedulerEvent, dateFrom: Date, dateTo: Date): void;
  /**
   ...
   */
  occurrenceAfter(eventObj: SchedulerEvent, date: number): void;
  /**
   ...
   */
  occurrenceBefore(eventObj: SchedulerEvent, date: number): void;
  /**
   ...
   */
  openEventTooltip(eventObj: SchedulerEvent | number): void;
  /**
   ...
   * @returns {boolean}
   */
  isEventRestricted(eventObj: SchedulerEvent | HTMLElement): boolean;
}
...
export interface SchedulerDataSource {
   ...
   * Default value: null
   */
  notifications?: SchedulerDataSourceNotification[];
}
...
export interface SchedulerDataSourceNotification {
  /**
...
export interface SchedulerEvent {
   ...
   * Default value: null
   */
  notifications?: SchedulerEventNotification[];
}
...
export interface SchedulerEventNotification {
  /**
   * The number of days/weeks when the notification should appear before the event starts.
   * Default value: 0
   */
