...
import { SchedulerRepeatFreq, SchedulerNotificationType, SchedulerDayFormat, SchedulerGroupOrientation, SchedulerHourFormat, SchedulerHeaderDatePosition, SchedulerHeaderNavigationStyle, SchedulerHeaderViewPosition, HorizontalScrollBarVisibility, MinuteFormat, MonthFormat, ResizeHandlesVisibility, SchedulerScrollButtonsPosition, SchedulerTimelineDayScale, VerticalScrollBarVisibility, SchedulerViewType, SchedulerViews, SchedulerViewSelectorType, WeekDayFormat, YearFormat, SchedulerDataExport, SchedulerDataSource, SchedulerDataSourceRepeat, SchedulerDataSourceNotification, SchedulerEvent, SchedulerEventRepeat, SchedulerEventNotification, SchedulerResource, SchedulerStatuse} from './../../index';
...
export class Scheduler extends React.Component<React.HTMLAttributes<Element> & SchedulerProps, any> {   
  ...
  */
	...
	* @returns {boolean}
  */
	public async containsEvent(eventObj:SchedulerEvent) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
	...
	*/
    public insertEvent(eventObj: SchedulerEvent, index?: number): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public updateEvent(index: number | SchedulerEvent, eventObj: SchedulerEvent): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public openWindow(index: number | SchedulerEvent): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public scrollToEvent(index: SchedulerEvent | number): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public occurrencesBetween(eventObj: SchedulerEvent, dateFrom: Date, dateTo: Date): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public occurrenceAfter(eventObj: SchedulerEvent, date: number): void {
        if (this.nativeElement.isRendered) {
	...
	*/
    public occurrenceBefore(eventObj: SchedulerEvent, date: number): void {
        if (this.nativeElement.isRendered) {
  ...
  */
	...
	*/
    public openEventTooltip(eventObj: SchedulerEvent | number): void {
        if (this.nativeElement.isRendered) {
  ...
  */
	...
	* @returns {boolean}
  */
	public async isEventRestricted(eventObj:SchedulerEvent | HTMLElement) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
