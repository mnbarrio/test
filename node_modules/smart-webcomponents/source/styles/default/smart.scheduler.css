...
.smart-container.smart-scheduler {
    overflow: hidden;
    display: grid;
...
smart-scheduler[show-footer]>.smart-container,
.smart-container.smart-scheduler {
    grid-template-rows: 1fr var(--smart-scheduler-footer-height);
}
...
/* .smart-scheduler[view-type="month"] .smart-scheduler-content .smart-scheduler-cell[weekend][other-month], */
...
.smart-scheduler[view-type="month"] .smart-scheduler-content .smart-scheduler-cell[nonworking][other-month] {
...
.smart-scheduler .smart-scheduler-view-header-horizontal .smart-scheduler-cell>div {
...
.smart-scheduler[view-type="agenda"] .smart-scheduler-view-header-vertical .smart-scheduler-cell[separator]:last-of-type::after,
...
.smart-scheduler .smart-scheduler-view-header-horizontal .smart-scheduler-cell:first-of-type {
    border-left: none;
}
...
.smart-scheduler .smart-scheduler-view-header-horizontal .smart-scheduler-cells div {
    overflow: hidden;
    text-overflow: ellipsis;
}

.smart-scheduler[view-type^="timeline"] .smart-scheduler-cells div {
    text-overflow: ellipsis;
    overflow: hidden;
}
...
/* .smart-scheduler[view-type="day"] .smart-scheduler-cells-container .smart-scheduler-cell.scale:not(:last-of-type),
.smart-scheduler[view-type="week"] .smart-scheduler-cells-container .smart-scheduler-cell.scale:not(:last-of-type) {
    border-bottom: var(--smart-border-width) solid rgba(var(--smart-border-rgb), 0.5);
} */
...
.smart-scheduler .smart-scheduler-view:focus .smart-scheduler-cell:not(.scale)[selected="start"] {
    /* box-shadow: 0 0 0 var(--smart-border-width) inset var(--smart-ui-state-border-active); */
...
.smart-scheduler .smart-scheduler-view-all-day .smart-scheduler-cell:hover {
...
/* .smart-scheduler .smart-scheduler-view-scroll-bar[orientation="vertical"]::before {
    position: absolute;
    width: 100%;
    background: var(--smart-scroll-bar-background);
    content: '';
    left: 0;
    top: calc(-1 * var(--smart-scheduler-timeline-header-horizontal-size));
    height: var(--smart-scheduler-timeline-header-horizontal-size);
...
.smart-scheduler[disable-view-menu] .smart-scheduler-view-items-button[hover],
.smart-scheduler[disable-view-menu] .smart-scheduler-view-items-button[focus] {
    background: transparent;
    color: var(--smart-background-color);
}

.smart-scheduler[disable-date-menu] .smart-scheduler-nav[current][hover] button.smart-button,
.smart-scheduler[disable-view-menu] .smart-scheduler-view-items-button[hover] button.smart-button {
    background: transparent;
    color: inherit;
}
...
.smart-scheduler[scroll-buttons-position="near"] .smart-scheduler-date-nav .smart-scheduler-nav[current],
...
/* .smart-scheduler .smart-scheduler-items-container .smart-scheduler-item[selected]::after {
    position: absolute;
    content: '';
    width: 100%;
    height:100%;
    pointer-events: none;
    box-shadow: 0 calc(2 * var(--smart-border-width)) 0 0 var(--smart-background);
    top: var(--smart-border-width);
} */
...
.smart-scheduler .smart-scheduler-view-items-button {
    ...
    /* margin-right: var(--smart-scheduler-header-padding); */
    overflow: hidden;
}
...
.smart-scheduler[header-view-position="near"] .smart-scheduler-view-items-button {
    margin-left: var(--smart-scheduler-header-padding);
}

/* .smart-scheduler .smart-scheduler-view-items-button:not(.smart-visibility-hidden)::after {
...
.smart-scheduler-tooltip .smart-scheduler-context-menu-item[disabled] {
    opacity: 0.55;
    cursor: default;
    pointer-events: none;
}
...
.smart-scheduler-tooltip .smart-scheduler-context-menu-item[selected] {
...
.smart-scheduler-window .smart-scheduler-window-button.ok {
    grid-area: buttonOk;
}
...
.smart-scheduler-window .smart-scheduler-window-button.delete {
...
/* .smart-window.smart-scheduler-window .smart-content-container>.smart-footer {
    display: grid;
    grid-template-columns: repeat(2, minmax(100px, auto)) minmax(0, 1fr) minmax(100px, auto);
    grid-column-gap: 10px;
    grid-template-areas: "buttonOk buttonCancel . buttonDelete";
} */

.smart-window.smart-scheduler-window .smart-content-container>.smart-content,
.smart-window.smart-scheduler-window .smart-scheduler-window-main,
.smart-window.smart-scheduler-window .smart-scheduler-window-repeat {
    display: grid;
    grid-row-gap: 10px;
}
...
.smart-window.smart-scheduler-window .smart-scheduler-window-main,
.smart-window.smart-scheduler-window .smart-scheduler-window-repeat,
.smart-scheduler-window .smart-scheduler-window.confirm .smart-scheduler-confirm-label {
    width: var(--smart-box-width);
    /* height: calc(var(--smart-box-height) / 1.75); */
}
...
.smart-window.smart-scheduler-window[horizontal] .smart-content-container>.smart-content {
    grid-template-columns: repeat(2, auto);
    grid-column-gap: 20px;
}

.smart-window.smart-scheduler-window .smart-scheduler-window-repeat [multiple] {
    grid-template-columns: minmax(0, 1fr);
}

.smart-window.smart-scheduler-window .smart-scheduler-window-repeat [multiple] .smart-scheduler-window-editor {
...
/* --- ColorInput Scheduler Custom Style --- */
...
.smart-scheduler-color-input.smart-color-input-drop-down-menu .grid-samples-container {
    grid-template-columns: repeat(2, minmax(0, 1fr));
}

.smart-scheduler-color-input.smart-color-input-drop-down-menu:not([animation="none"]) .default-samples-container div {
    transition: transform 0.2s ease-in-out;
}

.smart-scheduler-color-input.smart-color-input-drop-down-menu .default-samples-container div {
    position: relative;
    border-radius: 50%;
    border: initial;
...
.smart-scheduler-color-input.smart-color-input-drop-down-menu .default-samples-container div.selected {
    transform: scale(1);
}

.smart-scheduler-color-input.smart-color-input-drop-down-menu .default-samples-container div.selected:not(.no-color):after {
    content: var(--smart-icon-check);
    width: 100%;
    height: 100%;
    position: absolute;
...
.smart-scheduler .smart-scheduler-event[hover]::after,
.smart-scheduler .smart-scheduler-event[focus]:after,
.smart-scheduler .smart-scheduler-event[hover]::before,
.smart-scheduler .smart-scheduler-event[focus]:before {
    transform: scale(1);
}
...
.smart-scheduler-tooltip .smart-scheduler-collector-event-list .smart-scheduler-event[repeating] .smart-scheduler-event-button,
.smart-scheduler-tooltip .smart-scheduler-collector-event-list .smart-scheduler-event[exception] .smart-scheduler-event-button {
    display: none;
}
...
.smart-scheduler-tooltip .smart-scheduler-context-menu-item {
...
.smart-scheduler-drag-feedback[view-type="agenda"] {
...
.smart-scheduler-drag-feedback:not([view-type="agenda"])[status] .smart-scheduler-event-content {
...
.smart-scheduler-tooltip .smart-scroll-viewer .smart-scroll-viewer-content-container {
    padding: initial;
}
...
.smart-scheduler-tooltip .smart-scheduler-event {
    ...
    outline: none;
    /* !important is nedded to keep the inline style of the event intact */
    --smart-scheduler-event-focus: var(--smart-ui-state-focus) !important;
    --smart-scheduler-event-color-focus: var(--smart-ui-state-color-focus) !important;
    --smart-scheduler-event-hover: var(--smart-ui-state-hover) !important;
    --smart-scheduler-event-color-hover: var(--smart-ui-state-color-hover) !important;
}

.smart-scheduler-tooltip .smart-scheduler-event:hover,
.smart-scheduler-tooltip .smart-scheduler-context-menu-item:hover {
    background: var(--smart-ui-state-hover);
    color: var(--smart-ui-state-color-hover);
}
...
.smart-scheduler-tooltip .smart-scheduler-event-label {
    font-weight: var(--smart-scheduler-event-item-label-font-weight);
}
...
.smart-scheduler-tooltip .smart-scheduler-event-content>div {
    max-width: 100%;
    max-height: 100%;
    overflow: hidden;
    text-overflow: ellipsis;
...
.smart-scheduler .smart-scheduler-event .smart-scheduler-event-content>div:not(:first-of-type),
.smart-scheduler .smart-scheduler-event:not([repeating]) .smart-scheduler-event-content>div,
.smart-scheduler-drag-feedback .smart-scheduler-event-content>div:not(:first-of-type),
.smart-scheduler-drag-feedback:not([repeating]) .smart-scheduler-event-content>div {
...
/* Scheduler Toast */
.smart-scheduler .smart-toast-container-custom {
...
.smart-scheduler .smart-toast-container-custom .smart-toast-item {
    border-radius: 5px;
    height: var(--smart-scheduler-toast-default-height);
}

.smart-scheduler .smart-toast-container-custom .smart-toast-item>.smart-container {
    display: flex;
    flex-direction: row-reverse;
}

.smart-scheduler .smart-toast-container-custom .smart-toast-item .smart-toast-item-container {
    padding: initial;
    top: initial;
    width: 100%;
}
...
.smart-scheduler[right-to-left] .smart-scheduler-nav[current] {
    order: 4;
}

.smart-scheduler[right-to-left] .smart-scheduler-nav[prev]::after {
    content: var(--smart-icon-arrow-right);
}

.smart-scheduler[right-to-left] .smart-scheduler-nav[next]::after {
    content: var(--smart-icon-arrow-left);
}

smart-scheduler[right-to-left]>.smart-container.vscroll .smart-scheduler-view,
.smart-container.smart-scheduler[right-to-left].vscroll .smart-scheduler-view {
...
.smart-scheduler[right-to-left] .smart-scheduler-view-scroll-bar::after {
    right: 100%;
    left: initial;
}
...
.smart-scheduler[right-to-left][group-by-date] .smart-scheduler-view[show-group-header="horizontal"] .smart-scheduler-cell[show-label="offset"]>div {
    margin-left: initial;
    margin-right: var(--smart-scheduler-timeline-group-header-offset);
}

.smart-scheduler[right-to-left][group-by-date] .smart-scheduler-view[show-group-header="horizontal"] .smart-scheduler-cell[show-label]>div {
    transform: translateX(calc(50% + var(--smart-scheduler-timeline-header-cell-padding)));
}
...
.smart-notification-panel .smart-button[delete] {
...
.smart-notification-panel .smart-button[delete]::after {
...
.smart-notification-panel .smart-button[delete]:hover {
    opacity: 0.6;
    color: var(--smart-ui-state-color-hover);
    background-color: var(--smart-ui-state-hover);
}

.smart-notification-panel .smart-button[delete]:active {
    color: var(--smart-ui-state-color-hover);
    background-color: var(--smart-ui-state-hover);
    opacity: 1;
}
