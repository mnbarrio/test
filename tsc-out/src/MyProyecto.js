...
export class MyProyecto extends LitElement {
    constructor() {
        ...
        this.color = "#132e49c8";
        this.color_fondo = "#132e49f2";
        this.categoria = "td";
        this.titulo_categoria = "Inteligencia Artificial";
        this.titulo_IA = "Inteligencia Artificial";
        this.titulo_TD = "Trasformación Digital";
...
], MyProyecto.prototype, "preempresa", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "proyecto", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "descripcion", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "color", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "color_fondo", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "categoria", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "titulo_categoria", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "titulo_IA", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "titulo_TD", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "video", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "fondo", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "instagram", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "facebook", void 0);
__decorate([
    property({ type: String })
], MyProyecto.prototype, "web", void 0);
__decorate([
    property({ type: Number })
], MyProyecto.prototype, "counteria", void 0);
__decorate([
    property({ type: Number })
], MyProyecto.prototype, "countertd", void 0);
__decorate([
    property({ type: Boolean })
], MyProyecto.prototype, "btd", void 0);
__decorate([
    property({ type: Boolean })
], MyProyecto.prototype, "bia", void 0);
__decorate([
    property({ type: Boolean })
], MyProyecto.prototype, "estado", void 0);
window.customElements.define('my-proyecto', MyProyecto);
//# sourceMappingURL=MyProyecto.js.map