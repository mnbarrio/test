...
export class MyCategory extends LitElement {
    constructor() {
        super(...arguments);
        this.up = "Inteligencia";
        this.down = "ARTIFICIAL";
        this.estilo = "azul";
    }
    static get styles() {
        return css `
...
], MyCategory.prototype, "up", void 0);
__decorate([
    property({ type: String })
], MyCategory.prototype, "down", void 0);
__decorate([
    property({ type: String })
], MyCategory.prototype, "estilo", void 0);
window.customElements.define('my-category', MyCategory);
//# sourceMappingURL=MyCategory.js.map